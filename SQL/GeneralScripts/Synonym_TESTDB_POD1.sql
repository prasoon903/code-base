/**************************************************************************************************************************************
REPLACE 'PARASHAR_TEST' WITH ACTUAL CoreIssue DATABASE NAME
REPLACE 'PARASHAR_CB_CL' WITH ACTUAL CoreLibrary DATABASE NAME
REPLACE 'PARASHAR_CB_CC' WITH ACTUAL CoreCollect DATABASE NAME
REPLACE 'PARASHAR_CB_CAuth' WITH ACTUAL CoreAuth DATABASE NAME
REPLACE 'PARASHAR_CB_CoreAPP' WITH ACTUAL CoreApp DATABASE NAME
REPLACE 'PARASHAR_CB_CoreCredit' WITH ACTUAL CoreCredit DATABASE NAME
**************************************************************************************************************************************/
---------------------------------------------------------------------------------------------------------------------------------------
USE PARASHAR_TEST

DECLARE @CAuth_db varchar(40) = 'PARASHAR_CB_CAuth' -- Core Auth DB Name
DECLARE @CI_db varchar(40) = 'PARASHAR_TEST' -- Core Issue DB Name
DECLARE @CL_db varchar(40) = 'PARASHAR_CB_CL' -- Core Library DB Name
DECLARE @CC_db varchar(40) = 'PARASHAR_CB_CC' -- Core Collect DB Name
DECLARE @CoreCredit_db varchar(40) = 'PARASHAR_CB_CoreCredit' -- CoreCredit DB Name
DECLARE @CoreApp_db varchar(40) = 'PARASHAR_CB_CoreAPP' -- CoreApp DB Name
