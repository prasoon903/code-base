DECLARE @AccountID INT = 14551620

SELECT BSAcctid, CP.ARTxnType, CP.TxnSource, RTRIM(CP.CMTTRANTYPE) AS CMTTRANTYPE,CP.TxnAcctId, txnsource, 
CP.creditplanmaster, EqualPayments, CP.TransactionAmount,CP.TranId,CP.TranRef,CP.tranorig,CP.RevTgt,
CP.atid,Trantime,CP.PostTime,CP.MemoIndicator
...
--AND CP.PostTime <= '2021-01-05 12:05:44.000'
ORDER BY CP.POSTTIME DESC

/*
DECLARE @AccountID INT = 2816286
