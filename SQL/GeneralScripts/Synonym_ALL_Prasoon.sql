/**************************************************************************************************************************************
REPLACE 'PRASOON_CB_CI' WITH ACTUAL CoreIssue DATABASE NAME
REPLACE 'PRASOON_CB_CL' WITH ACTUAL CoreLibrary DATABASE NAME
REPLACE 'PRASOON_CB_CC' WITH ACTUAL CoreCollect DATABASE NAME
REPLACE 'PRASOON_CB_CAuth' WITH ACTUAL CoreAuth DATABASE NAME
REPLACE 'PRASOON_CB_CoreAPP' WITH ACTUAL CoreApp DATABASE NAME
REPLACE 'PRASOON_CB_CoreCredit' WITH ACTUAL CoreCredit DATABASE NAME
**************************************************************************************************************************************/
---------------------------------------------------------------------------------------------------------------------------------------
USE PRASOON_CB_CI

DECLARE @CAuth_db varchar(40) = 'PRASOON_CB_CAuth' -- Core Auth DB Name
DECLARE @CI_db varchar(40) = 'PRASOON_CB_CI' -- Core Issue DB Name
DECLARE @CL_db varchar(40) = 'PRASOON_CB_CL' -- Core Library DB Name
DECLARE @CC_db varchar(40) = 'PRASOON_CB_CC' -- Core Collect DB Name
DECLARE @CoreCredit_db varchar(40) = 'PRASOON_CB_CoreCredit' -- Core Collect DB Name
DECLARE @CoreApp_db varchar(40) = 'PRASOON_CB_CoreAPP' -- Core Collect DB Name
