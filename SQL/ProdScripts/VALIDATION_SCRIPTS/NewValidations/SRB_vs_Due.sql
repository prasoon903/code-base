...
WHERE BusinessDay = '2022-03-30 23:59:57'
AND SYstemStatus <> 14
...
JOIN CPSgmentAccounts CPS WITH (NOLOCK) ON (PIR.CPSAcctID = CPS.acctId AND PIR.BusinessDay = '2022-03-30 23:59:57')
JOIN #BSRecords BS WITH (NOLOCK) ON (BS.BSAcctId = CPS.parent02AID)
WHERE PIR.BusinessDay = '2022-03-30 23:59:57'
...
DateOfOriginalPaymentDueDTD = ''2022-03-31 23:59:57'',	DtOfLastDelinqCTD = NULL,	FirstDueDate = ''2022-03-31 23:59:57''	
WHERE acctID =	' + TRY_CAST(BSAcctID AS VARCHAR) BSegmentCreditCard
FROM #Accounts_Fixed
WHERE CycleDueDTD = 1
ORDER BY BSAcctID
