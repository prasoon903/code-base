...
SELECT 
A.acctId, RTRIM(BP.AccountNumber) AccountNumber, BP.UniversalUniqueID AccountUUID, BCC.SRBWithInstallmentDue MSBAtPresent, BS.DisputesAmtNS DisputeAmtAtPresent, BP.CycleDueDTD,
