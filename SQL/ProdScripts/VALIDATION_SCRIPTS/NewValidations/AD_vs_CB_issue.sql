...
AND ((CurrentBalance+CurrentBalanceCO < AmountOfTotalDue AND AmountOfTotalDue > 0) OR (CurrentBalance+CurrentBalanceCO <= 0 AND CycleDueDTD > 0))
...
JOIN AccountInfoForReport A WITH (NOLOCK) ON (I.BSacctId = A.BSAcctID AND A.BusinessDay = '2021-12-30 23:59:57')
...
WHERE P.BusinessDay = '2021-12-30 23:59:57'
...
SELECT * FROM #Accounts WHERE CycleDueDTD = 1
...
RunningMinimumDue = 0, RemainingMinimumDue = 0, SRBWithInstallmentDue = 0, DaysDelinquent = 0, TotalDaysDelinquent = 0, 
