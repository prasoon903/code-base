...
'UPDATE TOP(1) AccountInfoForReport SET ccinhParent127AID = ' + TRY_CAST(ccinhParent127AID AS VARCHAR) + ' WHERE BSAcctID = ' + TRY_CAST(BSAcctID AS VARCHAR) + ' AND BusinessDay = ''2022-02-28 23:59:57.000'''
...
WHERE SH.StatementDate = '2022-02-28 23:59:57.000'
...
WHERE AIR.BusinessDay = '2022-02-28 23:59:57.000'
...
'UPDATE TOP(1) AccountInfoForReport SET TotalDaysDelinquent = ' + TRY_CAST(DaysDelinquent AS VARCHAR) + ' WHERE BSAcctID = ' + TRY_CAST(BSAcctID AS VARCHAR) + ' AND BusinessDay = ''2022-02-28 23:59:57.000'''
...
--Q26
SELECT BSAcctID, CycleDueDTD, TotalDaysDelinquent, DaysDelinquent, DateOfOriginalPaymentDueDTD, DateOfDelinquency, 
'UPDATE TOP(1) AccountInfoForReport SET TotalDaysDelinquent = ' + TRY_CAST(DaysDelinquent AS VARCHAR) + ' WHERE BSAcctID = ' + TRY_CAST(BSAcctID AS VARCHAR) + ' AND BusinessDay = ''2022-02-28 23:59:57.000''' AccountInfoForReport,
'UPDATE TOP(1) StatementHeaderEX SET NoPayDaysDelinquent = ' + TRY_CAST(DaysDelinquent AS VARCHAR) + ' WHERE AcctID = ' + TRY_CAST(BSAcctID AS VARCHAR) + ' AND StatementDate = ''2022-02-28 23:59:57.000''' StatementHeaderEX
FROM LS_PRODDRGSDB01.ccgs_coreissue_secondary.dbo.AccountInfoForReport AIR WITH (NOLOCK) 
WHERE AIR.BusinessDay = '2022-02-28 23:59:57.000'
...
'UPDATE TOP(1) AccountInfoForReport SET CycleDueDTD = 0' + TRY_CAST(DaysDelinquent AS VARCHAR) + ' WHERE BSAcctID = ' + TRY_CAST(BSAcctID AS VARCHAR) + ' AND BusinessDay = ''2022-02-28 23:59:57.000'''
FROM LS_PRODDRGSDB01.ccgs_coreissue_secondary.dbo.AccountInfoForReport AIR WITH (NOLOCK) 
WHERE AIR.BusinessDay = '2022-02-28 23:59:57.000'
...
FROM LS_PRODDRGSDB01.ccgs_coreissue_secondary.dbo.StatementHeader AIR WITH (NOLOCK) 
WHERE AIR.StatementDate = '2022-02-28 23:59:57.000'
...
--Q20
SELECT BSAcctID, CycleDueDTD, TotalDaysDelinquent, DaysDelinquent, DateOfOriginalPaymentDueDTD, DateOfDelinquency, 
'UPDATE TOP(1) AccountInfoForReport SET TotalDaysDelinquent = 1, DaysDelinquent = 1, DateOfOriginalPaymentDueDTD = ''2022-02-28 23:59:57.000'' WHERE BSAcctID = ' + TRY_CAST(BSAcctID AS VARCHAR) + ' AND BusinessDay = ''2022-02-28 23:59:57.000''' AccountInfoForReport,
'UPDATE TOP(1) StatementHeader SET DateOfOriginalPaymentDueDTD = ''2022-02-28 23:59:57.000'' WHERE AcctID = ' + TRY_CAST(BSAcctID AS VARCHAR) + ' AND StatementDate = ''2022-02-28 23:59:57.000''' StatementHeader,
'UPDATE TOP(1) StatementHeaderEx SET NoPayDaysDelinquent = 1, DaysDelinquent = 1 WHERE AcctID = ' + TRY_CAST(BSAcctID AS VARCHAR) + ' AND StatementDate = ''2022-02-28 23:59:57.000''' StatementHeaderEX
FROM LS_PRODDRGSDB01.ccgs_coreissue_secondary.dbo.AccountInfoForReport AIR WITH (NOLOCK) 
WHERE AIR.BusinessDay = '2022-02-28 23:59:57.000'
