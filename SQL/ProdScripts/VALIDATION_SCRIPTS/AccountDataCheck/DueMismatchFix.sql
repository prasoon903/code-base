...
DECLARE @LastDay DATETIME = '2022-02-11 23:59:57' , @LastSTMTDate DATETIME = '2022-01-31 23:59:57', @Flag INT
...
(9921, 57444, 47486, 16566388, 166948, 2626437, 14031777)
...
BEGIN
	...
	--SELECT * FROM #Corrected_BS WHERE BSAcctId = 50753640

	--SELECT * FROM #Corrected_PS WHERE BSAcctId = 50753640
END
