...
FROM LS_PRODDRGSDB01.ccgs_coreissue.dbo.BSegmentCreditCard  b  WITH(NOLOCK)  
JOIN LS_PRODDRGSDB01.ccgs_coreissue.dbo.BSegment_Primary  bp  WITH(NOLOCK) ON (b.acctid = bp.acctid )
JOIN LS_PRODDRGSDB01.ccgs_coreissue.dbo.AStatusAccounts a WITH(NOLOCK)  ON (a.merchantaid =  bp.parent05aid  and   a.parent01aid  = bp.ccinhparent125aid )
