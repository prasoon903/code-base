...
SELECT * FROM #FinalImpacted_All WHERE acctID = 183150 ORDER BY acctID, RecordNumber
SELECT * FROM #Final_AllAccounts WHERE acctID = 183150 ORDER BY acctID, RecordNumber
