...
BEGIN TRY
	BEGIN TRANSACTION
		INSERT INTO #Batch (SN, TxnAcctId, AccountNumber, TransactionAmount, CMTTranType, ActualTranCode, TranTime, JobStatus)
		SELECT TOP(@BatchCount) SN, TxnAcctId, AccountNumber, TransactionAmount, CMTTranType, ActualTranCode, TranTime, JobStatus
