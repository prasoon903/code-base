...
SELECT Skey,acctId,RTRIM(AccountNumber) AS AccountNumber ,AccountUUID,PurchaseTranId,TranTime,TransactionLifeCycleUniqueID,TransactionUUID,DisputeID,TotalRewardPoints,RTRIM(DisputeStage) as DisputeStage,ClaimID FROM #TempMapped
