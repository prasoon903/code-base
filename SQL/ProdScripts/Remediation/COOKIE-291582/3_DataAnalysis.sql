...
SELECT CaseID,TransactionUUID,AccountUUID,Amount FROM #InValidData
...
--SELECT * FROM ##TempRecords WHERE TransactionUUID = '3163a8d0-3e2a-4617-a601-c399fdf2c9d6'
...
SELECT acctId,RTRIM(AccountNumber) AS AccountNumber ,AccountUUID,PurchaseTranId,TranTime,TransactionLifeCycleUniqueID,TransactionUUID,DisputeID,TotalRewardPoints,RTRIM(DisputeStage) as DisputeStage,ClaimID FROM #TempMapped
