...
SELECT AccountNumber, BP.acctID BSAcctID, BP.LastStatementDate, CP.acctID, CP.DisputesAmtNS, CP.CurrentBalance+CPC.CurrentbalanceCO CurrentBalance, CPC.PaidOutDate 
