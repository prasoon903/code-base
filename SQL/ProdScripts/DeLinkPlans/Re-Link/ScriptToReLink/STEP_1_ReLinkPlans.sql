DECLARE @AccountOfPlanToReLink INT = 0

--========================================== PASS THE ACCOUNT ID FOR WHICH DE-LINKED PLANS NEED TO LINK =========================================

SET @AccountOfPlanToReLink = 602255
...
SELECT acctID, parent02AID, parent01AID
FROM CPSgmentAccounts WITH (NOLOCK)
WHERE parent02AID = -@AccountOfPlanToReLink
...
BEGIN
	...
	WHERE BP.acctID = @AccountOfPlanToReLink
	ORDER BY CPS.acctID
