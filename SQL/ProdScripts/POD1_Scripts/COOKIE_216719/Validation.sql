...
SELECT 'TempData_CT_111770', COUNT(1) FROM LS_P1MARPRODDB01.ccgs_CoreIssue.dbo.TempData_CT_111770
SELECT 'TempXRef_CT_111770', COUNT(1) FROM LS_P1MARPRODDB01.ccgs_CoreIssue.dbo.TempXRef_CT_111770


SELECT 'CPSgmentAccounts', COUNT(1)
FROM CPSgmentAccounts CPS WITH (NOLOCK)
JOIN LS_P1MARPRODDB01.ccgs_CoreIssue.dbo.TempData_CT_111770 T1 ON (CPS.acctID = T1.PlanID)

SELECT 'ILPScheduleDetailSummary', COUNT(1)
FROM ILPScheduleDetailSummary ILP WITH (NOLOCK)
JOIN LS_P1MARPRODDB01.ccgs_CoreIssue.dbo.TempData_CT_111770 T1 ON (ILP.PlanID = T1.PlanID)

SELECT 'ILPScheduleDetails', COUNT(1)
FROM ILPScheduleDetails ILP WITH (NOLOCK)
JOIN LS_P1MARPRODDB01.ccgs_CoreIssue.dbo.TempData_CT_111770 T1 ON (ILP.acctId = T1.PlanID)
...
JOIN LS_P1MARPRODDB01.ccgs_CoreIssue.dbo.TempData_CT_111770 T ON (X.ParentATID = 51 AND X.parentAID = T.parent02AID AND ChildATID = 52 AND X.ChildAID = T.PlanID)
