...
JOIN statementvalidation T1 ON (AIR.bsacctid  = T1.acctid  AND AIR.BusinessDay = '2022-04-30 23:59:57'
 and  T1.statementdate  = AIR.BusinessDay ) where   T1.validationfail = 'Q10'
