...
'UPDATE TOP(1) PlanInfoForReport SET AmtOfPayCurrDue = ' + TRY_CAST(round(currentdue,2) AS VARCHAR) + ' WHERE CPSacctId = ' + TRY_CAST(S.acctId AS VARCHAR) + ' AND BusinessDay = ''2022-03-31 23:59:57.000'''
...
where statementdate = '2022-03-31 23:59:57.000'  
and   (((abs(currentdue)*100) - CONVERT(INT,(abs(currentdue)*100))) <> 0) 

SELECT '''2022-03-31 23:59:57.000'''
...
WHERE SH.StatementDate = '2022-03-31 23:59:57.000'
