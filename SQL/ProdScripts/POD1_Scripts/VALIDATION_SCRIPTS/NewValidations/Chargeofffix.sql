...
, AmountOfPayment30DLate =  0  ,  AmountOfPayment60DLate = 0  ,
 ...
 AmountOfPayment150DLate = 0  ,  AmountOfPayment180DLate  = 0  , AmountOfPayment210DLate = 0 ,cycleduedtd = 0  ,DateOfOriginalPaymentDUeDTD =  null ,
  daysdelinquent  = 0 , Totaldaysdelinquent = 0 , dateofdelinquency = null   where   bsacctid  = ' +  cast(acctid  as varchar)  + ' and businessday  = ' + '''2022-03-31 23:59:57'''   as accountinfoforreport,
...
from  LS_PRODDRGSDB01.ccgs_coreissue_secondary.dbo.statementheader s  with(nolock) 
where    statementdate = '2022-03-31 23:59:57' 
and  systemstatus = 14   
...
--and CycleDueDTD = 0
--and  acctid  in (select  acctid   from LS_PRODDRGSDB01.CCGS_CoreIssue.dbo.StatementValidation  with(nolock) where  statementdate = '2022-03-31 23:59:57' )
...
JOIN LS_PRODDRGSDB01.CCGS_CoreIssue.dbo.bSegment_Primary BS WITH (NOLOCK)  ON (SV.acctId = BS.acctId AND SV.StatementDate = '2022-03-31 23:59:57.000')
JOIN LS_PRODDRGSDB01.CCGS_CoreIssue.dbo.StatementJobs SJ WITH (NOLOCK)  ON (SJ.acctId = BS.acctId AND SJ.StatementDate = SV.StatementDate)
WHERE SV.StatementDate = '2022-03-31 23:59:57.000' --AND ValidationFail = 'Q23'
...
, AmountOfPayment30DLate =  0  ,  AmountOfPayment60DLate = 0  ,
 AmountOfPayment90DLate = 0   ,  AmountOfPayment120DLate  = 0 ,
 AmountOfPayment150DLate = 0  ,  AmountOfPayment180DLate  = 0  , AmountOfPayment210DLate = 0 ,cycleduedtd = 1  where   bsacctid  = ' +  cast(acctid  as varchar)  + ' and businessday  = ' + '''2022-03-31 23:59:57'''   as accountinfoforreport,
...
'update    top(1)  accountinfoforreport   set   CycleDueDTD = 1  where   bsacctid  = ' +  cast(acctid  as varchar)  + ' and businessday  = ' + '''2022-03-31 23:59:57'''   as accountinfoforreport,  
...
, AmountOfPayment30DLate =  0  ,  AmountOfPayment60DLate = 0  ,
 AmountOfPayment90DLate = 0   ,  AmountOfPayment120DLate  = 0 ,
 AmountOfPayment150DLate = 0  ,  AmountOfPayment180DLate  = 0  , AmountOfPayment210DLate = 0 ,cycleduedtd = 0    where   cpsacctid  = ' +  cast(sh.acctid  as varchar)  + ' and businessday  = ' + '''2022-03-31 23:59:57'''   as planinfoforreport,
...
join   LS_PRODDRGSDB01.ccgs_coreissue.dbo.summaryheadercreditcard  sh  with(nolock) on (s.acctid  = sh.acctid  and  s.statementid = sh.statementid )
join   LS_PRODDRGSDB01.ccgs_coreissue_secondary.dbo.statementheader   st  with(nolock) on (s.parent02aid  = st.acctid  and  s.statementid = st.statementid )
...
and  s.statementdate = '2022-03-31 23:59:57' 
...
'update      top(1) summaryheadercreditcard    set   cycleduedtd = 1 where   acctId  = ' +  cast(s.acctid  as varchar)  + ' and statementid  = ' +  cast(s.statementid as varchar)  as summaryheadercreditcard  ,
 'update   top(1)   planinfoforreport   set   cycleduedtd = 1    where   cpsacctid  = ' +  cast(sh.acctid  as varchar)  + ' and businessday  = ' + '''2022-03-31 23:59:57'''   as planinfoforreport,
...
, AmountOfPayment30DLate =  0  ,  AmountOfPayment60DLate = 0  ,
 AmountOfPayment90DLate = 0   ,  AmountOfPayment120DLate  = 0 ,
 AmountOfPayment150DLate = 0  ,  AmountOfPayment180DLate  = 0  , AmountOfPayment210DLate = 0 ,cycleduedtd = 1    where   cpsacctid  = ' +  cast(sh.acctid  as varchar)  + ' and businessday  = ' + '''2022-03-31 23:59:57'''   as planinfoforreport,
...
--select  sh.currentbalanceco + s.currentbalance, s.creditplantype,s.amountoftotaldue,currentdue ,st.amountoftotaldue,st.acctid ,* from  LS_PRODDRGSDB01.ccgs_coreissue_secondary.dbo.summaryheader s  with(nolock) 
--join   LS_PRODDRGSDB01.ccgs_coreissue.dbo.summaryheadercreditcard  sh  with(nolock) on (s.acctid  = sh.acctid  and  s.statementid = sh.statementid )
--join   LS_PRODDRGSDB01.ccgs_coreissue_secondary.dbo.statementheader   st  with(nolock) on (s.parent02aid  = st.acctid  and  s.statementid = st.statementid )
--where  s.parent02aid   in (  select  acctid   from LS_PRODDRGSDB01.CCGS_CoreIssue.dbo.StatementValidation  with(nolock) where  statementdate = '2022-03-31 23:59:57')
--and  s.statementdate = '2022-03-31 23:59:57' and st.systemstatus = 14    and   st.amountoftotaldue > 0   and  st.CurrentBalance+ st.CurrentBalanceco   <= 0  and s.creditplantype = '16'
...
and (statementdate = '2022-03-31 23:59:57'  and ccinhparent125aid = 16324 ) and currentbalance <=0 
...
,256318,20590875,34554099,34554100,600501,4970734,33691424,671644,5220745,21924960,21934920,66215965,66810225,69368003,1267778,44752305,45639852,45639853,1368698,8350272,52876922,52876923,1521063,41925982,41925983,67986893,1737940,13449029,53804903,53804904,1860785,16149698,23421774,23421775)
 ...
 and statementdate = '2022-03-31 23:59:57'
