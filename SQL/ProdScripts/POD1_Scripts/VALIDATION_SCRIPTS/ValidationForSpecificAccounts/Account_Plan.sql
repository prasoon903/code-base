...
BEGIN
	...
	DECLARE @StatementDate DATETIME = '2022-12-31 23:59:57'
	...
	--JOIN LS_P1MARPRODDB01.CCGS_CoreIssue.dbo.bSegment_Primary BS WITH (NOLOCK)  ON (SV.acctId = BS.acctId AND SV.StatementDate = @StatementDate)
	...
	FROM LS_P1MARPRODDB01.CCGS_CoreIssue.dbo.BSegmentCreditCard BC WITH (NOLOCK)
	...
	FROM LS_P1MARPRODDB01.CCGS_CoreIssue.dbo.CPSgmentCreditCard CC WITH (NOLOCK)
...
UPDATE TOP(1) #BSegment_Primary SET CycleDueDTD = 0, SystemStatus = 2, AmtOfPayCurrDue = 0 WHERE acctID = 949059
UPDATE TOP(1) #BSegment_Primary SET CycleDueDTD = 0, SystemStatus = 2, AmtOfPayCurrDue = 0 WHERE acctID = 3219876
UPDATE TOP(1) #BSegment_Primary SET CycleDueDTD = 0, SystemStatus = 2, AmtOfPayCurrDue = 0 WHERE acctID = 14107465
UPDATE TOP(1) #BSegment_Primary SET CycleDueDTD = 0, SystemStatus = 2, AmtOfPayCurrDue = 0 WHERE acctID = 20030428

UPDATE TOP(1) #BSegmentCreditCard SET AmountOfTotalDue = 0, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0,  RunningMinimumDue = 0, RemainingMinimumDue = 0, SRBWithInstallmentDue = 0, DaysDelinquent = 0, NoPayDaysDelinquent = 0,   DAteOfOriginalPaymentDueDTD = NULL, DtOfLastDelinqCTD = NULL, FirstDueDate = NULL  WHERE acctID = 949059
UPDATE TOP(1) #BSegmentCreditCard SET AmountOfTotalDue = 0, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0,  RunningMinimumDue = 0, RemainingMinimumDue = 0, SRBWithInstallmentDue = 0, DaysDelinquent = 0, NoPayDaysDelinquent = 0,   DAteOfOriginalPaymentDueDTD = NULL, DtOfLastDelinqCTD = NULL, FirstDueDate = NULL  WHERE acctID = 3219876
UPDATE TOP(1) #BSegmentCreditCard SET AmountOfTotalDue = 0, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0,  RunningMinimumDue = 0, RemainingMinimumDue = 0, SRBWithInstallmentDue = 0, DaysDelinquent = 0, NoPayDaysDelinquent = 0,   DAteOfOriginalPaymentDueDTD = NULL, DtOfLastDelinqCTD = NULL, FirstDueDate = NULL  WHERE acctID = 14107465
UPDATE TOP(1) #BSegmentCreditCard SET AmountOfTotalDue = 0, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0,  RunningMinimumDue = 0, RemainingMinimumDue = 0, SRBWithInstallmentDue = 0, DaysDelinquent = 0, NoPayDaysDelinquent = 0,   DAteOfOriginalPaymentDueDTD = NULL, DtOfLastDelinqCTD = NULL, FirstDueDate = NULL  WHERE acctID = 20030428


UPDATE TOP(1) #CPSgmentCreditCard SET CycleDueDTD = 0, AmountOfTotalDue = 0, AmtOfPayCurrDue = 0, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0 WHERE acctID = 961479
UPDATE TOP(1) #CPSgmentCreditCard SET CycleDueDTD = 0, AmountOfTotalDue = 0, AmtOfPayCurrDue = 0, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0 WHERE acctID = 65539043
UPDATE TOP(1) #CPSgmentCreditCard SET CycleDueDTD = 0, AmountOfTotalDue = 0, AmtOfPayCurrDue = 0, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0 WHERE acctID = 66988242
UPDATE TOP(1) #CPSgmentCreditCard SET CycleDueDTD = 0, AmountOfTotalDue = 0, AmtOfPayCurrDue = 0, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0 WHERE acctID = 69310609


UPDATE TOP(1) #BSegment_Primary SET CycleDueDTD = 1, SystemStatus = 2, AmtOfPayCurrDue = 77.82 WHERE acctID = 1615448
UPDATE TOP(1) #BSegment_Primary SET CycleDueDTD = 1, SystemStatus = 2, AmtOfPayCurrDue = 15.17 WHERE acctID = 2688263
UPDATE TOP(1) #BSegment_Primary SET CycleDueDTD = 1, SystemStatus = 2, AmtOfPayCurrDue = 11.32 WHERE acctID = 9606132
UPDATE TOP(1) #BSegment_Primary SET CycleDueDTD = 1, SystemStatus = 2, AmtOfPayCurrDue = 17.14 WHERE acctID = 10818565


UPDATE TOP(1) #BSegmentCreditCard SET AmountOfTotalDue = 77.82, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0,  RunningMinimumDue = 77.82, RemainingMinimumDue = 77.82, DaysDelinquent = 0, NoPayDaysDelinquent = 0,   DateOfOriginalPaymentDueDTD = '2023-01-31 23:59:57', DtOfLastDelinqCTD = NULL, FirstDueDate = '2023-01-31 23:59:57'   WHERE acctID = 1615448
UPDATE TOP(1) #BSegmentCreditCard SET AmountOfTotalDue = 15.17, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0,  RunningMinimumDue = 15.17, RemainingMinimumDue = 15.17, DaysDelinquent = 0, NoPayDaysDelinquent = 0,   DateOfOriginalPaymentDueDTD = '2023-01-31 23:59:57', DtOfLastDelinqCTD = NULL, FirstDueDate = '2023-01-31 23:59:57'   WHERE acctID = 2688263
UPDATE TOP(1) #BSegmentCreditCard SET AmountOfTotalDue = 11.32, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0,  RunningMinimumDue = 11.32, RemainingMinimumDue = 11.32, DaysDelinquent = 0, NoPayDaysDelinquent = 0,   DateOfOriginalPaymentDueDTD = '2023-01-31 23:59:57', DtOfLastDelinqCTD = NULL, FirstDueDate = '2023-01-31 23:59:57'   WHERE acctID = 9606132
UPDATE TOP(1) #BSegmentCreditCard SET AmountOfTotalDue = 17.14, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0,  RunningMinimumDue = 17.14, RemainingMinimumDue = 17.14, DaysDelinquent = 0, NoPayDaysDelinquent = 0,   DateOfOriginalPaymentDueDTD = '2023-01-31 23:59:57', DtOfLastDelinqCTD = NULL, FirstDueDate = '2023-01-31 23:59:57'   WHERE acctID = 10818565


UPDATE TOP(1) #CPSgmentCreditCard SET CycleDueDTD = 0, AmountOfTotalDue = 0, AmtOfPayCurrDue = 0, AmtOfPayXDLate = 0, AmountOfPayment30DLate = 0, AmountOfPayment60DLate = 0 WHERE acctID = 1627868

UPDATE TOP(1) #CPSgmentCreditCard SET AmountOfTotalDue = 11.32, AmtOfPayCurrDue = 11.32 WHERE acctID = 23698290
UPDATE TOP(1) #CPSgmentCreditCard SET AmountOfTotalDue = 13.85, AmtOfPayCurrDue = 13.85 WHERE acctID = 27571577
UPDATE TOP(1) #CPSgmentCreditCard SET AmountOfTotalDue = 15.17, AmtOfPayCurrDue = 15.17 WHERE acctID = 43535706
