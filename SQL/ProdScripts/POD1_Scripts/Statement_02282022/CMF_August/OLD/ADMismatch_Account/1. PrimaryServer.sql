...
UPDATE TOP(1) BSegment_Primary SET CycleDueDTD = 0 WHERE acctId = 4346940

UPDATE TOP(1) BSegmentCreditCard SET AmountOfPayment30DLate = AmountOfPayment30DLate + 0.46 WHERE acctId = 7819098
UPDATE TOP(1) BSegment_Primary SET AmtOfPayCurrDue = AmtOfPayCurrDue - 54.68 WHERE acctId = 7819098
