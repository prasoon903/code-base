...
BEGIN
	...
	VALUES ('COOKIE-292364', 2327663, '1100011123131074', 0.25, '17', '1701')
	INSERT INTO TransactionCreationTempData (JiraID, TxnAcctId, AccountNumber, TransactionAmount, CMTTranType, ActualTranCode)   
	VALUES ('COOKIE-292364', 2902805, '1100011129171694', 0.01, '17', '1701')
END

IF @PODID = 2
BEGIN
	INSERT INTO TransactionCreationTempData (JiraID, TxnAcctId, AccountNumber, TransactionAmount, CMTTranType, ActualTranCode)   
	VALUES ('COOKIE-292364', 51753171, '1200012002590280', 0.77, '17', '1701')
	INSERT INTO TransactionCreationTempData (JiraID, TxnAcctId, AccountNumber, TransactionAmount, CMTTranType, ActualTranCode)   
	VALUES ('COOKIE-292364', 52348986, '1200012006430319', 0.51, '17', '1701')
END

IF @PODID = 4
BEGIN
	INSERT INTO TransactionCreationTempData (JiraID, TxnAcctId, AccountNumber, TransactionAmount, CMTTranType, ActualTranCode)   
	VALUES ('COOKIE-292364', 106501122, '1300111087627238', 0.51, '17', '1701')
	INSERT INTO TransactionCreationTempData (JiraID, TxnAcctId, AccountNumber, TransactionAmount, CMTTranType, ActualTranCode)   
	VALUES ('COOKIE-292364', 102704099, '1300111041360546', 1.28, '17', '1701')
END
