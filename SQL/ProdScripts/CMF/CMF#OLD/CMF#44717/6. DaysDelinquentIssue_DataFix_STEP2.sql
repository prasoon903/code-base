...
BEGIN
	...
	Begin 
		BEGIN TRY
			...
			INSERT INTO #TempAccountsJobTable (Skey, acctId, FirstDueDate, NoPayDaysDelinquent, DaysDelinquent, JobStatus)
			SELECT TOP(@BatchCount)
				Skey, acctId, FirstDueDate, NoPayDaysDelinquent, DaysDelinquent, JobStatus
