...
BEGIN TRANSACTION
	...
	UPDATE TOP(1) BSegment_Primary SET CycleDueDTD = 0, AmtOfPayCurrDue = AmtOfPayCurrDue - 8.84 WHERE acctId = 9855752
	UPDATE TOP(1) BSegmentCreditCard SET AmountOfTotalDue = AmountOfTotalDue - 8.84, RunningMinimumDue = RunningMinimumDue - 25.31, 
	RemainingMinimumDue = RemainingMinimumDue - 25.31, DateOfOriginalPaymentDueDTD = NULL  WHERE acctId = 9855752

	INSERT INTO CurrentBalanceAudit (tid,businessday,atid,aid,dename,oldvalue,newvalue)
	VALUES
	(32220355667, '2020-11-10 08:22:10.000', 51, 9855752, 115, '1', '0'),
	(32220355667, '2020-11-10 08:22:10.000', 51, 9855752, 200, '8.84', '0.00')	
