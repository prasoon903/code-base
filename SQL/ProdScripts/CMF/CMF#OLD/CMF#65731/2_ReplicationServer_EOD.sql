...
AmtOfPayPastDue = AmtOfPayPastDue -20.75, DateOfOriginalPaymentDUeDTD = '2022-04-30 23:59:57.000', DAteOfDelinquency = NULL  WHERE BSAcctID = 2296309 AND BusinessDay = '2022-03-31 23:59:57.000'

UPDATE TOP(1) PlanInfoForReport SET CycleDueDTD = 1, SystemStatus = 2, SRBWithInstallmentDue = SRBWithInstallmentDue -20.75, 
 SBWithInstallmentDue = SBWithInstallmentDue -20.75, 
SBWithInstallmentDue = SBWithInstallmentDue - 20.75, AmountOfTotalDue = AmountOfTotalDue - 20.75, AmountOfPayment30DLate = AmountOfPayment30DLate - 20.75,
AmtOfPayPastDue = AmtOfPayPastDue -20.75 WHERE BSAcctID = 2296309 AND CPSAcctid = 44220466 AND BusinessDay = '2022-03-31 23:59:57.000'
