...
BEGIN
	...
	DROP TABLE IF EXISTS BKP_ILPScheduleDetailSummary_20201028
	DROP TABLE IF EXISTS BKP_ILPScheduleDetailsRevised_20201028

	SELECT ILP.* 
	INTO BKP_ILPScheduleDetailSummary_20201028
	...
	SELECT ILP.* 
	INTO BKP_ILPScheduleDetailsRevised_20201028
