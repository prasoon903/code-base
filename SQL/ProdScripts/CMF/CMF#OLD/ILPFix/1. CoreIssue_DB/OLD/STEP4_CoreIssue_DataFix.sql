DROP PROCEDURE IF EXISTS USP_FixILPSchedules
GO
CREATE PROCEDURE USP_FixILPSchedules (@BatchCount INT, @Ranking INT)
AS
BEGIN
					...
					BEGIN TRANSACTION
						...
						BEGIN
							UPDATE ILP
								...
								JOIN #TempAccountsJobTable TT ON (ILP.PlanID = TT.PlanID)
