...
BEGIN TRANSACTION
	...
	UPDATE TOP(1) AccountInfoForReport SET CycleDueDTD = 0, SystemStatus = 2, AmountOfTotalDue = AmountOfTotalDue - 9.03, AmtOfPayXDLate = AmtOfPayXDLate - 9.03, RunningMinimumDue = RunningMinimumDue - 9.03, 
	...
	UPDATE TOP(1) AccountInfoForReport SET CycleDueDTD = 0, AmtOfPayCurrDue = AmtOfPayCurrDue - 11.18, AmountOfTotalDue = AmountOfTotalDue - 11.18, RunningMinimumDue = RunningMinimumDue - 11.18, 
