DECLARE @JiraID VARCHAR(20) = 'COOKIE-275535'
...
FROM LS_P1MARPRODDB01.ccgs_coreissue.dbo.Trans_In_Acct WITH (NOLOCK)
...
SELECT BSAcctId,PostingRef,hostmachinename, AccountNumber, * FROM LS_P1MARPRODDB01.ccgs_coreissue.dbo.CCard_Primary CP WITH (NOLOCK) WHERE TranId IN ( 81302157672)
--81302157672
--81302037604
