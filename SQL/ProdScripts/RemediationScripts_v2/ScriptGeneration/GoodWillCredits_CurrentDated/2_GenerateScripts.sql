...
DECLARE @JIRAID VARCHAR(20) = 'COOKIE-278020'
DECLARE @TranCode VARCHAR(20) = '5001'
...
VALUES (''' + @JIRAID + ''', ' + TRY_CONVERT(VARCHAR, acctID) + ', '''+RTRIM(AccountNumber)+''', ' + TRY_CONVERT(VARCHAR, TransactionAmount) + ', ''50''' + ', '''+ @TranCode +''')'
FROM #TempCombined
