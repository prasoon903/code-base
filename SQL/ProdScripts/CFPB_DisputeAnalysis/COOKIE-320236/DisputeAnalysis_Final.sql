...
--SELECT DISTINCT UniversalUniqueID
--FROM BSegment_Primary WITH (NOLOCK)
--WHERE UniversalUniqueID IN
--(
--SELECT distinct AccountUUID FROM #NoDisputeAmount)

--SELECT distinct AccountUUID, DisputeAmount FROM #NoDisputeAmount
...
SELECT COUNT(DISTINCT acctID) FROM #Final_AllAccounts WHERE PHPImpactWithStatusCheck = 'YES'
...
select * from #Final_AllAccounts where acctid = 12380563 ORDER BY acctID, RecordNumber
