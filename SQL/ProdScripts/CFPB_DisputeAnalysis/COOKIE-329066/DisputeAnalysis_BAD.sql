...
BEGIN
	...
	--SELECT WaiveMinDue, StatusDescription, *
	--FROM AStatusAccounts WITH (NOLOCK)
	--WHERE TRY_CAST(ISNULL(WaiveMinDue, '0') AS INT) > 0
	--AND parent01AID = 1
	...
	CASE 
		WHEN T2.CycleDueDTD > T1.CycleDueDTD + 1 AND T2.CycleDueDTD - T3.CycleDueDTD <= 1 
		THEN 
			CASE 
				WHEN T2.ccinhparent125AID IN (15996, 16000, 16326)
				THEN T1.CycleDueDTD
				ELSE T1.CycleDueDTD + 1
			 END
		ELSE T2.CycleDueDTD 
	END NextDQ,
	...
	CASE	WHEN NextDQ >= 1 AND NextDQ > T2.CycleDueDTD
			THEN 
				CASE	WHEN T2.RN = 2 AND T2.SRB_Calc > 0 AND (T2.MiniDue_Calc+T2.AmountOfPayment210DLate+T2.AmountOfPayment180DLate+T2.AmountOfPayment150DLate+T2.AmountOfPayment120DLate+T2.AmountOfPayment90DLate+T2.AmountOfPayment60DLate+T2.AmountOfPayment30DLate+T2.AmtOfPayXDLate) >= T2.SRB_Calc 
						...
						ELSE 
							...
							END						
				END
				WHEN NextDQ >= 1 AND NextDQ = T2.CycleDueDTD 
				THEN					
					CASE	
						WHEN T2.MiniDue_Calc < T2.AmtOfPayCurrDue
						THEN T2.MiniDue_Calc
						ELSE T2.AmtOfPayCurrDue
					END	 
			ELSE 0 
	...
	CASE WHEN NextDQ >= 2 AND NextDQ <> T2.CycleDueDTD THEN CASE WHEN T1.AmtOfPayCurrDue < T2.AmtOfPayXDLate THEN T1.AmtOfPayCurrDue ELSE T2.AmtOfPayXDLate END WHEN NextDQ >= 2 AND NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmtOfPayXDLate < T2.AmtOfPayXDLate THEN T1.AmtOfPayXDLate ELSE T2.AmtOfPayXDLate END ELSE 0 END+
	CASE WHEN NextDQ >= 3 AND NextDQ <> T2.CycleDueDTD THEN CASE WHEN T1.AmtOfPayXDLate < T2.AmountOfPayment30DLate THEN T1.AmtOfPayXDLate ELSE T2.AmountOfPayment30DLate END WHEN NextDQ >= 3 AND NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment30DLate < T2.AmountOfPayment30DLate THEN T1.AmountOfPayment30DLate ELSE T2.AmountOfPayment30DLate END ELSE 0 END+
	CASE WHEN NextDQ >= 4 AND NextDQ <> T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment30DLate < T2.AmountOfPayment60DLate THEN T1.AmountOfPayment30DLate ELSE T2.AmountOfPayment60DLate END WHEN NextDQ >= 4 AND NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment60DLate < T2.AmountOfPayment60DLate THEN T1.AmountOfPayment60DLate ELSE T2.AmountOfPayment60DLate END ELSE 0 END+
	CASE WHEN NextDQ >= 5 AND NextDQ <> T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment60DLate < T2.AmountOfPayment90DLate THEN T1.AmountOfPayment60DLate ELSE T2.AmountOfPayment90DLate END WHEN NextDQ >= 5 AND NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment90DLate < T2.AmountOfPayment90DLate THEN T1.AmountOfPayment90DLate ELSE T2.AmountOfPayment90DLate END ELSE 0 END+
	CASE WHEN NextDQ >= 6 AND NextDQ <> T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment90DLate < T2.AmountOfPayment120DLate THEN T1.AmountOfPayment90DLate ELSE T2.AmountOfPayment120DLate END WHEN NextDQ >= 6 AND NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment120DLate < T2.AmountOfPayment120DLate THEN T1.AmountOfPayment120DLate ELSE T2.AmountOfPayment120DLate END ELSE 0 END+
	CASE WHEN NextDQ >= 7 AND NextDQ <> T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment120DLate < T2.AmountOfPayment150DLate THEN T1.AmountOfPayment120DLate ELSE T2.AmountOfPayment150DLate END WHEN NextDQ >= 7 AND NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment150DLate < T2.AmountOfPayment150DLate THEN T1.AmountOfPayment150DLate ELSE T2.AmountOfPayment150DLate END ELSE 0 END+
	CASE WHEN NextDQ >= 8 AND NextDQ <> T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment150DLate < T2.AmountOfPayment180DLate THEN T1.AmountOfPayment150DLate ELSE T2.AmountOfPayment180DLate END WHEN NextDQ >= 8 AND NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment180DLate < T2.AmountOfPayment180DLate THEN T1.AmountOfPayment180DLate ELSE T2.AmountOfPayment180DLate END ELSE 0 END+
	CASE WHEN NextDQ >= 9 AND NextDQ <> T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment180DLate+T1.AmountOfPayment210DLate < T2.AmountOfPayment180DLate THEN T1.AmountOfPayment180DLate+T1.AmountOfPayment210DLate ELSE T2.AmountOfPayment180DLate END WHEN NextDQ >= 9 AND NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment210DLate < T2.AmountOfPayment210DLate THEN T1.AmountOfPayment210DLate ELSE T2.AmountOfPayment210DLate END ELSE 0 END,
	...
	CASE	WHEN NextDQ >= 1 AND NextDQ > T2.CycleDueDTD
			...
			ELSE 0 
	END,
	CASE WHEN NextDQ >= 2 THEN CASE WHEN NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmtOfPayXDLate < T2.AmtOfPayXDLate THEN T1.AmtOfPayXDLate ELSE T2.AmtOfPayXDLate END WHEN T2.CycleDueDTD - T3.CycleDueDTD > 1 AND T2.CycleDueDTD = 2 THEN T2.AmtOfPayXDLate ELSE CASE WHEN T1.AmtOfPayCurrDue < T2.AmtOfPayXDLate THEN T1.AmtOfPayCurrDue ELSE T2.AmtOfPayXDLate END END ELSE 0 END,	
	CASE WHEN NextDQ >= 3 THEN CASE WHEN NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment30DLate < T2.AmountOfPayment30DLate THEN T1.AmountOfPayment30DLate ELSE T2.AmountOfPayment30DLate END WHEN T2.CycleDueDTD - T3.CycleDueDTD > 1 AND T2.CycleDueDTD = 3 THEN T2.AmountOfPayment30DLate ELSE CASE WHEN T1.AmtOfPayXDLate < T2.AmountOfPayment30DLate THEN T1.AmtOfPayXDLate ELSE T2.AmountOfPayment30DLate END END ELSE 0 END,	 
	CASE WHEN NextDQ >= 4 THEN CASE WHEN NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment60DLate < T2.AmountOfPayment60DLate THEN T1.AmountOfPayment60DLate ELSE T2.AmountOfPayment60DLate END WHEN T2.CycleDueDTD - T3.CycleDueDTD > 1 AND T2.CycleDueDTD = 4 THEN T2.AmountOfPayment60DLate ELSE CASE WHEN T1.AmountOfPayment30DLate < T2.AmountOfPayment60DLate THEN T1.AmountOfPayment30DLate ELSE T2.AmountOfPayment60DLate END END ELSE 0 END,	   
	CASE WHEN NextDQ >= 5 THEN CASE WHEN NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment90DLate < T2.AmountOfPayment90DLate THEN T1.AmountOfPayment90DLate ELSE T2.AmountOfPayment90DLate END WHEN T2.CycleDueDTD - T3.CycleDueDTD > 1 AND T2.CycleDueDTD = 5 THEN T2.AmountOfPayment90DLate ELSE CASE WHEN T1.AmountOfPayment60DLate < T2.AmountOfPayment90DLate THEN T1.AmountOfPayment60DLate ELSE T2.AmountOfPayment90DLate END END ELSE 0 END,	  
	CASE WHEN NextDQ >= 6 THEN CASE WHEN NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment90DLate < T2.AmountOfPayment90DLate THEN T1.AmountOfPayment120DLate ELSE T2.AmountOfPayment120DLate END WHEN T2.CycleDueDTD - T3.CycleDueDTD > 1 AND T2.CycleDueDTD = 6 THEN T2.AmountOfPayment120DLate ELSE CASE WHEN T1.AmountOfPayment90DLate < T2.AmountOfPayment120DLate THEN T1.AmountOfPayment90DLate ELSE T2.AmountOfPayment120DLate END END ELSE 0 END,	 
	CASE WHEN NextDQ >= 7 THEN CASE WHEN NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment150DLate < T2.AmountOfPayment150DLate THEN T1.AmountOfPayment150DLate ELSE T2.AmountOfPayment150DLate END WHEN T2.CycleDueDTD - T3.CycleDueDTD > 1 AND T2.CycleDueDTD = 7 THEN T2.AmountOfPayment150DLate ELSE CASE WHEN T1.AmountOfPayment120DLate < T2.AmountOfPayment150DLate THEN T1.AmountOfPayment120DLate ELSE T2.AmountOfPayment150DLate END END ELSE 0 END,	 
	CASE WHEN NextDQ >= 8 THEN CASE WHEN NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment180DLate < T2.AmountOfPayment180DLate THEN T1.AmountOfPayment180DLate ELSE T2.AmountOfPayment180DLate END WHEN T2.CycleDueDTD - T3.CycleDueDTD > 1 AND T2.CycleDueDTD = 8 THEN T2.AmountOfPayment180DLate ELSE CASE WHEN T1.AmountOfPayment150DLate < T2.AmountOfPayment180DLate THEN T1.AmountOfPayment150DLate ELSE T2.AmountOfPayment180DLate END END ELSE 0 END,	  
	CASE WHEN NextDQ >= 9 THEN CASE WHEN NextDQ = T2.CycleDueDTD THEN CASE WHEN T1.AmountOfPayment210DLate < T2.AmountOfPayment210DLate THEN T1.AmountOfPayment210DLate ELSE T2.AmountOfPayment210DLate END WHEN T2.CycleDueDTD - T3.CycleDueDTD > 1 AND T2.CycleDueDTD = 9 THEN T2.AmountOfPayment210DLate ELSE CASE WHEN T1.AmountOfPayment180DLate+T1.AmountOfPayment210DLate < T2.AmountOfPayment180DLate THEN T1.AmountOfPayment180DLate+T1.AmountOfPayment210DLate ELSE T2.AmountOfPayment180DLate END END ELSE 0 END,	 
...
select * from #Final_AllAccounts where acctid = 18721833 ORDER BY acctID, RecordNumber
