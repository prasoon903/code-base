...
--SELECT * FROM #TempRecords WHERE acctID = 12714731
--SELECT * FROM #TempInt1 WHERE acctID = 17321541
--2405264
...
--SELECT * FROM #TempInt1 WHERE acctID = 18721833
--SELECT * FROM #TempInterest WHERE acctID = 18721833
...
CASE 
	WHEN T1.StatementDate BETWEEN T1.ClearingLastStatement AND T1.PCNextStatement 
		...
		AND T2.ccinhparent125aid NOT IN (15996, 16000, 16326, 16330) 
	THEN 'YES' 
	ELSE 'NO' 
