...
def DataValidation(FileID, FileName, ExceptionFileName):
    ...
    Query = "EXEC " + CI_DB + "..USP_InsertInto_IntraDayAccountOTBRule_Internal '" + FileID + "', '" + FileName + "' ,'" + str(InstitutionID) + "', '" + POTBPolicy  +  "', '" + str(POTBIdentifier) + "'" +  ", '" + str(ExceptionFileName) + "'," + str(ShardMigrationStatusCheck)
    ...
    if Error is False:
        ...
        for File in glob.glob("*"):
            ...
            if ABORT is False:
                ...
                ABORT, ErrorFlag, ErrorMessage, TotalCount, SuccessCount, ErrorCountForAccountFile, ArchiveCount, notprocessedCount, FileDetailsEmailBody = DataValidation(FileNameId, FileName, ExceptionFileName)
