...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.Apply_DBCr_FileLog') )
BEGIN
	CREATE TABLE DBO.Apply_DBCr_FileLog
	(
		SKey decimal(19,0) identity(1,1),
		JobID decimal(19,0),
		Step varchar(50),
...
BEGIN
	...
	(
		UniqueId DECIMAL(19,0) IDENTITY(1,1),
		...
		AccountTransactionSequence int NULL,
