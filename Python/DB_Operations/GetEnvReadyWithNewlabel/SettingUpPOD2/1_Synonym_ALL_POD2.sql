/**************************************************************************************************************************************
REPLACE 'PP_POD2_CI' WITH ACTUAL CoreIssue DATABASE NAME
REPLACE 'PP_POD2_CL' WITH ACTUAL CoreLibrary DATABASE NAME
REPLACE 'PP_POD2_CC' WITH ACTUAL CoreCollect DATABASE NAME
REPLACE 'PP_POD2_CAuth' WITH ACTUAL CoreAuth DATABASE NAME
REPLACE 'PP_POD2_CoreAPP' WITH ACTUAL CoreApp DATABASE NAME
REPLACE 'PP_POD2_CoreCredit' WITH ACTUAL CoreCredit DATABASE NAME
**************************************************************************************************************************************/
---------------------------------------------------------------------------------------------------------------------------------------
...
DECLARE @CAuth_db varchar(40) = 'PP_POD2_CAuth' -- Core Auth DB Name
DECLARE @CI_db varchar(40) = 'PP_POD2_CI' -- Core Issue DB Name
DECLARE @CL_db varchar(40) = 'PP_POD2_CL' -- Core Library DB Name
DECLARE @CC_db varchar(40) = 'PP_POD2_CC' -- Core Collect DB Name
DECLARE @CoreCredit_db varchar(40) = 'PP_POD2_CoreCredit' -- CoreCredit DB Name
DECLARE @CoreApp_db varchar(40) = 'PP_POD2_CoreAPP' -- CoreApp DB Name
DECLARE @CI_secondary varchar(40) = 'PP_POD2_CI_Secondary' -- CoreIssue Secondary DB Name
...
DECLARE @CL_db varchar(40) = 'PP_POD2_CL' -- Core Library DB Name
DECLARE @CC_db varchar(40) = 'PP_POD2_CC' -- Core Collect DB Name
DECLARE @CoreCredit_db varchar(40) = 'PP_POD2_CoreCredit' -- Core Collect DB Name
DECLARE @CoreApp_db varchar(40) = 'PP_POD2_CoreAPP' -- Core Collect DB Name
