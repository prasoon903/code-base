...
DECLARE @CoreCredit_db varchar(40) = 'PP_JAZZ_CoreCredit' -- CoreCredit DB Name
DECLARE @CoreApp_db varchar(40) = 'PP_JAZZ_CoreApp' -- CoreApp DB Name
DECLARE @CI_secondary varchar(40) = 'PP_JAZZ_CI_Secondary' -- CoreIssue Secondary DB Name
...
DECLARE @CoreApp_db varchar(40) = 'PP_JAZZ_CoreApp' -- Core Collect DB Name
...
/****** Object:  Synonym [dbo].[SYN_CoreApp_AppDataInput]    Script Date: 9/4/2018 3:24:56 AM ******/
CREATE SYNONYM [dbo].[SYN_CoreApp_AppDataInput] FOR [PP_JAZZ_CoreApp].[dbo].[ApplicationInputData]
GO