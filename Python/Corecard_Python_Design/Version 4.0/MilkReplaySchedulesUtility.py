...
class SetUp:
    ...
    CAuth_DB = "KK_CAuth"
    SERVERNAME = "XEON-S8"
    RetailInputFile = "D:\PLAT\Dump\MilkReplaySchedules\INPUT"
    RetailErrorFile = "D:\PLAT\Dump\MilkReplaySchedules\ERROR"
    RetailOutFile = "D:\PLAT\Dump\MilkReplaySchedules\OUT"
    RetailLogFile = "D:\PLAT\Dump\MilkReplaySchedules\LOG"
    RetailInsitutionID = 6969
    MailFrom = "krunal.kumbhare@corecard.com"
    MailTo = "krunal.kumbhare@corecard.com"
    SMTP_SERVER = "corecard-com.mail.protection.outlook.com"
    SMTPPORT = 25
    RetailEnvironment = "LOCAL"
    OTBReleaseFileIN='K:\Dump\Plat\OTBRelaseAPI\Incoming_file'
    OTBReleaseFileError='K:\Dump\Plat\OTBRelaseAPI\Error'
    OTBReleaseFileOUT='K:\Dump\Plat\OTBRelaseAPI\Processed'
    OTBReleaseFileLog='K:\Dump\Plat\OTBRelaseAPI\Log'
    SQLLiteOTBDBPath='K:\Dump\Plat\OTBRelaseAPI\SQLite_DB'
    RetailExceptionFile = "D:\PLAT\Dump\MilkReplaySchedules\EXCEPTION"
...
def EmailStructure_Subject():
    EMailSubject = "Alert | PLAT - " + S1.RetailEnvironment + " ::: Milk Replay Schedules file processing"
...
def DataValidation(FileID, FileName, MessageLogger):
    ...
    try:
        ...
        IsExceptionFile = FileName.find(S1.RetailExceptionFilePrefix)
        ...
        Query = "EXEC " + S1.CI_DB + "..USP_ValidateRetailReplaySchedules '" + FileName + "', '" + FileID + "', " + str(S1.BatchCount) + ", " + str(S1.AccountNumberCheck) + ", " + str(FileType) + ", '" + str(ExceptionFile) + "'"
...
def GenerateExceptionFile(FileID, FileName, ExceptionFile, MessageLogger):
    ...
    try:
        ...
        #ExceptionFileName = S1.RetailExceptionFile + "\\" + GetExceptionFileName(MessageLogger, FileName)
...
def get_secret(MessageLogger): 
    ...
    secret_name = S1.RetailAWS_secret_name
    region_name = S1.RetailAWS_region_name 
    ...
    try: 
        ...
        client = session.client(
            service_name=S1.RetailAWS_service_name,
