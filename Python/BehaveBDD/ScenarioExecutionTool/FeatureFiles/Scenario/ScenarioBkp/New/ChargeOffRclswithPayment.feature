Feature: Chargeoff reclass with payment
...
Scenario: Test Given
    Given Test Given
    Then Age system to "2018-02-08" Date
...
Scenario: Create Account With BillingCycle 31
    ...
    And Save tag into variable "AccountCreation"
      And Age system to "2018-02-09" Date
