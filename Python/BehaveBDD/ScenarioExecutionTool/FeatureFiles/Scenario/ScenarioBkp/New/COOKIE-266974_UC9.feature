...
Scenario: Post purchase 2
  ...
  Given execute Post retailpurchase_2 of $1200 by trancode F4005 on CPM 13776
...
Scenario: Age system Statement-4 to 27
  Given Get AccountSummary
  Then Save tag into variable "AccountSummary"
...
Scenario: Post payment/GWC
  Given execute Post credit_1 of $SRBWithInstallmentDue by trancode 4907
  Then  Age system to "2020-07-10" Date
