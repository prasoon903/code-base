Feature: COOKIE-264963_CBRefund_Sc8
...
Scenario: Post dispute resolution of purchase_1
  Given execute Post disputeresolution_1 of $300 for Dispute_1 with action 2
  
Scenario: Aging
    Given Test Given
    Then Age system to "2018-07-04" Date
	
Scenario: Aging
    Given Test Given
    Then Age system to "2018-07-25" Date
