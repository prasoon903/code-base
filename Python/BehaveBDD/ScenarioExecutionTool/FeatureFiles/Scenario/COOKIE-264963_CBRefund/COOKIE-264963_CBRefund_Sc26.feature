Feature: COOKIE-264963_CBRefund_Sc26
...
Scenario: Post dispute resolution of purchase_1
  Given execute Post disputeresolution_2 of $250 for Dispute_1 with action 5
  Then  Age system to "2018-05-02" Date
  
Scenario: Add dispute of retailpurchase_1
  Given execute Post Dispute_3 of $300 for retailpurchase_1
  Then  Age system to "2018-06-05" Date
  
Scenario: Post return of retailpurchase_1
  Given execute Post return_1 of $300 by trancode F4103 of retailpurchase_1
  
Scenario: Post dispute resolution of retailpurchase_1
  Given execute Post disputeresolution_3 of $300 for Dispute_3 with action 4
