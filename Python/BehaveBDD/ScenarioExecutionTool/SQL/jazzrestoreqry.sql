...
,	@DBLocation NVARCHAR(MAX) = N'\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\Posting2.0_'

EXEC SP_RESTOREDB_Enhanced
@DB_NAME = N'PP_JAZZ_CC'
,@BACKUP_FILE= N'\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\Posting2.0_CC.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\Posting2.0_CAuth.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\Posting2.0_CoreApp.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\Posting2.0_CL.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\Posting2.0_CI.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\Posting2.0_CI_Secondary.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\Posting2.0_CoreCredit.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
