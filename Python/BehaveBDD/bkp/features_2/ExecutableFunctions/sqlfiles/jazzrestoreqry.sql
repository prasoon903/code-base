...
,@BACKUP_FILE= N' \\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\PostingBDD_CI.bak'
...
,	@DBLocation NVARCHAR(MAX) = N'\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\PostingBDD_'

EXEC SP_RESTOREDB_Enhanced
@DB_NAME = N'PP_JAZZ_CC'
,@BACKUP_FILE= N'\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\PostingBDD_CC.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\PostingBDD_CAuth.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\PostingBDD_CoreApp.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\PostingBDD_CL.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\PostingBDD_CI.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\PostingBDD_CI_Secondary.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
...
,@BACKUP_FILE='\\BPLDEVDB01\Prasoon_Parashar\JazzDB\Backup\PostingBDD_CoreCredit.bak'
,@MDF_LOCATION = @MDF
,@LDF_LOCATION = @LDF
